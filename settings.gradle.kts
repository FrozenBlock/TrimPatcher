...
include("tp-common")
project(":tp-common").projectDir = file("common")

if (Constants.FABRIC) {
    include("tp-fabric")
    project(":tp-fabric").projectDir = file("fabric")
}

if (Constants.NEOFORGE) {
    include("tp-neoforge")
    project(":tp-neoforge").projectDir = file("neoforge")
}
