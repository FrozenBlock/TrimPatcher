...
public abstract class BlockModelWrapperUnbakedMixin {
	...
	public ItemModel trimPatcher$createAutoTrimmedArmors(
		...
		final List<String> applicableOverlayMaterials = TrimPatcher.getApplicableOverlayMaterials(armorMaterialGuess);
		...
		final List<SelectItemModel.SwitchCase<ResourceKey<TrimMaterial>>> newTrimOverlays = new ArrayList<>();
